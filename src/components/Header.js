...
const Header = () => {
  ...
  // TO SHOW THE MOBILE VIEW
  const [hidden, setHidden] = useState(true)

  // TO MAKE THE SEARCH BOX FOR MOBILE AND WEB TO FUNCTION
  const navigate = useNavigate()

  // TO ACTIVATE THE DARKMODE
  useEffect(() => {
      ...
      <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-2 dark:border-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div id='mobile-nav' className="flex md:order-2">
            {/* TO SET DARKMODE */}
            <button onClick={() => setDarkMode(!darkMode)} id="theme-toggle" type="button" className="text-gray-500 mx-2 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
            ...
            <div className="relative hidden md:block">
              ...
              {/* TO MAKE THE SEARCH BOX SEARCH (using the search box) WHEN YOU ADD MOVIE for WEB */}
          ...
          {/* TO SHOW THE SEARCH HIDDEN MENU FOR MOBILE */}
          <div className={`items-center justify-between ${hidden ? "hidden" : ""} w-full md:flex md:w-auto md:order-1`} id="navbar-search">
            <div className="relative mt-3 md:hidden">
              ...
              {/* TO MAKE THE SEARCH BOX SEARCH (using the search box) WHEN YOU ADD MOVIE FOR MOBILE */}
              <form onSubmit={handleSubmit}>
                <input type="text" id="search-navbar" name='search' className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." autoComplete='off' />
              </form>
            </div>
